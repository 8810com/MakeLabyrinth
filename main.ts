...
scene.onHitWall(SpriteKind.Player, function (sprite, location) {
    if (mySprite.tileKindAt(TileDirection.Top, sprites.dungeon.collectibleRedCrystal)) {
        mySprite.sayText("The door opens", 500, true)
        tiles.setTileAt(location, sprites.dungeon.floorLight2)
        for (let 値 of tiles.getTilesByType(assets.tile`myTile1`)) {
            tiles.setTileAt(値, sprites.dungeon.stairEast)
            tiles.setWallAt(値, false)
...
sprites.onOverlap(SpriteKind.Enemy2, SpriteKind.player2, function (sprite, otherSprite) {
	
})
info.player4.onLifeZero(function () {
    info.setLife(120)
    tiles.placeOnRandomTile(mySprite4, sprites.dungeon.floorDarkDiamond)
})
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Projectile, function (sprite, otherSprite) {
    if (mySprite) {
        mySprite2.startEffect(effects.fire, 50)
...
sprites.onOverlap(SpriteKind.Enemy2, SpriteKind.Player, function (sprite, otherSprite) {
    if (true) {
        mySprite3.startEffect(effects.fire, 50)
...
info.player3.onLifeZero(function () {
    ...
    mySprite3.startEffect(effects.ashes, 50)
    info.player3.changeLifeBy(300)
    info.changeScoreBy(100)
})
sprites.onOverlap(SpriteKind.player3, SpriteKind.Player, function (sprite, otherSprite) {
    game.showLongText("赤い宝玉と宝には秘密がある", DialogLayout.Top)
})
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Projectile2, function (sprite, otherSprite) {
    info.player3.changeLifeBy(-1)
    info.changeScoreBy(1)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile2`, function (sprite, location) {
    music.playMelody("D E D F E G F E ", 120)
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    [img`
        ...
        . . f e 2 f f f f f f 2 e f . . 
        . . f f f f e e e e f f f f . . 
        . f f 6 f b f 4 4 f b f e f f . 
        . f 6 6 6 1 f d d f 1 4 e e f . 
        . . f 6 e f d d d d d e e f . . 
        . f d 6 e e 4 4 4 4 e e f . . . 
        . f b 6 f 2 2 2 2 2 2 f 4 e . . 
        . f b 6 f 2 2 2 2 2 2 f d 4 . . 
        . . f 6 f f 4 5 5 4 4 f 4 4 . . 
        . . . f f f f f f f f . . . . . 
        . . . . . f f . . f f . . . . . 
        `,img`
        . . . . . . . . . . . . . . . . 
        ...
        . f f e 2 f f f f f f 2 e f f . 
        . f f f f f e e e e f f f f f . 
        . 6 f e f b f 4 4 f b f e f . . 
        . 6 f e 4 1 f d d f 1 4 e f . . 
        6 6 6 f e 4 d d d d 4 e f e . . 
        f 6 f e f 2 2 2 2 e d d 4 e . . 
        f 6 f 4 f 2 2 2 2 e d d e . . . 
        f 6 f . f 4 4 5 5 f e e . . . . 
        . f f . f f f f f f f . . . . . 
        . . . . f f f . . . . . . . . . 
        `,img`
        . . . . . . . . . . . . . . . . 
        ...
        . . f e e 2 2 2 2 2 2 e f f . . 
        . f f e 2 f f f f f f 2 e f f . 
        . f f f 5 f e e e e f f f f f . 
        . . 5 e f b 5 4 4 f b f e f . . 
        . 5 f 5 6 5 f 5 d f 1 4 e f . . 
        . . e 6 6 6 f d d d 4 e f . . . 
        . . f 6 6 6 2 2 2 2 2 f e f . . 
        . . f 5 6 5 2 2 2 2 2 f 4 e . . 
        . . 5 b 6 4 5 5 5 4 4 f . . . . 
        . . . f 6 c f f f f f f . . . . 
        . . . . f f . . . f f f . . . . 
        `,img`
        ...
        . 5 . . 5 . f f f f . 5 . . 5 . 
        . . . . f f f 2 2 f f f . . . . 
        2 . 5 f f f 2 2 2 2 f f f 5 . 2 
        . . f f f e e e e e e f f f . . 
        . 5 f e e 2 2 2 2 2 2 e f f 5 . 
        . f 5 e 5 f 5 f f f f 2 e f f . 
        . f f f 5 f e e e e f f f f f . 
        . . 5 e 8 b 5 4 4 f b f e f 5 . 
        . . f 5 8 5 f d d f 1 4 e f f 2 
        2 . e 8 8 8 d d d d 4 e f f d f 
        . . e 5 8 5 e 2 2 2 2 f e f b f 
        . . 5 e 8 d 5 2 2 2 2 f 4 f b f 
        . . . . 5 e f 5 5 4 4 f 5 f c f 
        . 5 . . 5 f f 5 f f f f . f f . 
        . . . 2 . . . . . f f f 2 . . 5 
        `],
    200,
    false
...
info.player2.onLifeZero(function () {
    ...
    info.player2.changeLifeBy(120)
})
sprites.onOverlap(SpriteKind.player2, SpriteKind.Enemy2, function (sprite, otherSprite) {
    if (true) {
        mySprite3.startEffect(effects.fire, 50)
        scene.cameraShake(4, 500)
        info.player1.changeLifeBy(-1)
...
mySprite2 = sprites.create(img`
    ...
    3 c b c c b f c b 3 c b 3 b f f 
...
game.onUpdateInterval(randint(800, 2000), function () {
